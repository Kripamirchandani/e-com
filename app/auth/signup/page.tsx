    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "32px" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "normal", letterSpacing: "-0.025em", color: "#111111", margin: 0 }}>CREATE ACCOUNT</h1>
          <p style={{ marginTop: "8px", fontSize: "14px", color: "rgba(17, 17, 17, 0.6)", margin: 0 }}>Enter your details to create an account.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          <div>
            <label style={{ display: "block", fontSize: "12px", fontWeight: 500, letterSpacing: "0.05em", color: "#111111", textTransform: "uppercase" }}>Full Name</label>
            <input
              type="text"
              name="fullName"
              ...
              style={{
                ...
                border: focusedField === "fullName" ? "1px solid #111111" : "1px solid #D1D5DB",
                backgroundColor: "#FFFFFF",
                padding: "12px 16px",
                fontSize: "14px",
                color: "#111111",
        ...
        <div style={{ marginTop: "32px", borderTop: "1px solid #F3F4F6", paddingTop: "24px", textAlign: "center" }}>
          <p style={{ fontSize: "12px", color: "rgba(17, 17, 17, 0.6)", margin: 0 }}>
            ...
            <a href="/auth/login" style={{ fontWeight: 500, color: "#111111", textDecoration: "underline", textUnderlineOffset: "4px" }}>
              Log In
            </a>
          </p>
        </div>
